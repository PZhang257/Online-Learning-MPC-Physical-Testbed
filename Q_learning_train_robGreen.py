...
speed_17 = experiment['m_speed_50']
...
time_exp_t_1 = []
time_exp_1 = []
for i in range(0,len(distance_real_1)):
    t_time = 0.4
...
for i in range(0,len(closest_list_1)-2):
...
speed_exp_1 = []
for i in range(0,len(df_distance_real_skew_1)):
...
ax.plot(speed_ave_1[0:200],'r.',label='robot1')
ax.plot(closest_list_1[0:200],'b',label='Experiment')
ax.plot
ax.legend()
...
dict_print = {'speed_ave_1':speed_ave_1}
a_file = open("speed_print_robGreen_adaptive.csv", "w")
#a_dict = {"a": 1, "b": 2}
#%%
...
df_q_values.to_csv('Q_values_Green_5.csv', index = False)
