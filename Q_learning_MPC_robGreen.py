# -*- coding: utf-8 -*-
"""
Created on Thu Dec  7 14:44:16 2023
...
#q_values = np.array(pd.read_csv('/Users/zhangpeng/Desktop/Q_values_Green_5.csv'))
q_values = np.array(pd.read_csv('C:/Users/zplrj/OneDrive/桌面/Research/PERL/Q_values_Green_5.csv'))
#"C:\Users\zplrj\OneDrive\Desktop\Research\PERL\Q_values_Green_5.csv"
...
speed_17 = experiment['m_speed_21']
closest_list_1 = []
...
w1 = 0.2 # location weight in the obj
w2 = .7 # speed weight in the obj
w3 = 0.8 # acceleration rate in the obj
...
def clientthread_1(conn):
    ...
    while run_threads:
        ...
        given_value = v_plan[5]
        #print("given_value = " + str(given_value))
        #print("rob_speed = " + str(rob_speed))

        
        #a = str('FF') + str(int(RPM[index[0]])) + str('E')
...
ax.plot
ax.plot(distance_real_skew_1[0:40],'r.',label="Robot1")
ax.plot(distance_exp_1[0:40],'b',label="Experiment ")
#ax.plot(x,app,label="robot1")
...
from matplotlib import pyplot as plt
fig, ax = plt.subplots(figsize=(10,5))
ax.plot(speed_ave_1[0:40],'r.',label='robot1')
ax.plot(closest_list_1[0:40],'b',label='Experiment')
ax.plot
ax.legend()
plt.xlabel('time index')
...
mse = mean_squared_error(speed_exp_1[10:40],speed_ave_1[10:40])
rmse = sqrt(mse)
print(rmse)
#%%
...
from sklearn.metrics import mean_squared_error
from math import sqrt
mse = mean_squared_error(distance_exp_1[10:40],distance_real_skew_1[10:40])
rmse = sqrt(mse)
print(rmse)
#%%
